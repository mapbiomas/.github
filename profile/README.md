...
## 🌍 Overview
Welcome to the official repository hub of MapBiomas, where we provide a comprehensive set of scripts and tools for processing land use and land cover data across South America, Central America, Africa, and Asia.

## 📂 Repository Summary

### 🗺️ Country Initiatives
- [**Argentina**](https://github.com/mapbiomas/argentina-all-initiatives)
- [**Bolivia**](https://github.com/mapbiomas/bolivia-all-initiatives)
...
- [**Venezuela**](https://github.com/mapbiomas/venezuela-all-initiatives)
- [**Antarctica**](https://github.com/mapbiomas/Antartica)
...
### 🛠️ Toolkits and Training
Toolkits to enhance your interaction with MapBiomas data:
- [**MapBiomas User Toolkit**](https://github.com/mapbiomas/user-toolkit)
- [**Analysis on-the-fly from MapBiomas Plattaform**](https://github.com/mapbiomas/platform-analysis)
- [**Training**](https://github.com/mapbiomas/training)
